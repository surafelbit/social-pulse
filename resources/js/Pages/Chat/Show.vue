    ...
    <AuthenticatedLayout>
        <div class="min-h-screen bg-gray-50">
            <div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <!-- Chat Header -->
                <div
                    class="bg-white rounded-lg shadow mb-6 p-4 flex items-center justify-between"
                >
                ...
                <!-- Messages Container -->
                <div
                    class="bg-white rounded-lg shadow flex flex-col h-96 md:h-screen md:max-h-screen"
                >
                    <!-- Messages List -->
                    <div
