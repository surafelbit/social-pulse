        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow">
              <div class="p-4 border-b border-gray-200">
                ...
                >
                  {{ showNewConversation ? 'Hide' : 'New Message' }}
                </button>
              </div>

              <!-- New Conversation Form -->
              <div v-if="showNewConversation" class="p-4 border-b border-gray-200 bg-gray-50">
                <input
                  v-model="searchQuery"
                  type="text"
              ...
              <!-- Pagination -->
              <div v-if="conversations.links" class="p-4 border-t border-gray-200">
          ...
          <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow h-full">
              <div v-if="!selectedConversation" class="flex flex-col items-center justify-center h-96">
                <svg
...
const getOtherUser = (conversation) => {
  ...
  return conversation.user_id === currentUserId ? conversation.recipient : conversation.user;
};
